...
useRouter(app, apiPostAdminBanner(router, upload));
useRouter(app, apiPostArticle(router));
useRouter(app, apiUpdateAdminArticle(router));
useRouter(app, apiPostNewTag(router));
useRouter(app, apiDeleteAdminImg(router));
useRouter(app, apiLogin(router, SECRET));
useRouter(app, apiGetTagsList(router));
